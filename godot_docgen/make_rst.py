...
# Classes which are native to the Godot editor.
NATIVE_GODOT_CLASSES: set[str] = {
    "int",
    "bool",
    "Array",
    "Variant",
...
def main() -> None:
    ...
    # TODO: Add parsing for .tscn files here
    ...
    # TODO: Create a separate list to track the scenes
    ...
    if class_def.inherits:
        ...
        while inherits in state.classes:
            ...
            if inode:
                ...
                break
        if inherits in NATIVE_GODOT_CLASSES:
            if not first:
                f.write(" **<** ")
            f.write(make_type(inherits, state))
...
def make_type(klass: str, state: State) -> str:
    ...
    if link_type in state.classes:
        ...
        return type_rst
    elif link_type in NATIVE_GODOT_CLASSES:
